...
description: "Compare active Terms copy against configured rewards, limits, geography, and qualifying conditions for one live program."
noindex: true
---
...
<Warning>
****Execution rules apply for overall FR verdict.** Do not analyze report outputs or give an overall sanity-check verdict from this doc alone. See [Report Execution + Runtime Checks](//runbooks/functional-review/report-execution-runtime-checks).**
</Warning>
