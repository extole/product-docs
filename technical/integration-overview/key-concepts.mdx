...
To see how an incoming event is matched to an existing profile, and what happens when two people share one identifier, see [How Extole Resolves a Person](/technical/integration-overview/how-extole-resolves-a-person).
...
To set a profile attribute from an event you send, see [Set Person Profile Data from an Event](/technical/integration-overview/set-person-profile-data-from-an-event).
