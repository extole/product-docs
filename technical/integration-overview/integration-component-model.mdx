...
The configuration view is one of three. Continue to [Add the Activity and Event Views](/technical/integration-overview/integration-activity-views) for the report-runner view and event-stream view every integration also carries, whichever build path brought you here.
