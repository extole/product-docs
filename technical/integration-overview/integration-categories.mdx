...
An integration is a campaign whose component tree connects Extole to an outside system. Every integration belongs to a category, and the category decides the component model, the resources the integration needs, and which build sequence to follow in [Create an Integration with the Management API](/technical/integration-overview/management-api-integration).
...
- [Create an Integration with the Management API](/technical/integration-overview/management-api-integration)
