...
For reward triggers and webhooks, use [Build a Reward Fulfillment Integration](/technical/building-partner-integrations/integration-types/integration-build-reward-fulfillment).
...
- Every requested activity has the correct `SHAREABLE` or `STEP` controller trigger.
