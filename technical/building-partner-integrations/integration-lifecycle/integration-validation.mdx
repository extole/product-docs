...
- The socket holds the three baseline views, a `test-event-view-v10.0` child on a Partner to Extole build, and the `reward-suppliers` configuration view on a reward fulfillment build.
