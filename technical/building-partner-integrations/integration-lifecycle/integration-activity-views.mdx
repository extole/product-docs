...
Every integration needs a **report-runner view** charting what it processed and an **event-stream view** carrying its live event feed. [Map Partner Events to Business Events](/technical/building-partner-integrations/integration-types/partner-events-map-to-business-events) adds the **Test Event** view after its business events and input rules exist.
