...
| [Map Partner Events to Business Events](/technical/building-partner-integrations/integration-types/partner-events-map-to-business-events) | Business events, input event rules, event data, the Test Event tab, and proof that each partner event reaches a business event | Partner to Extole |
