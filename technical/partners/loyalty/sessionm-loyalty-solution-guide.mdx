...
<Frame caption="Marketing placement examples">
  <img src="/images/extole/d5ac44a2fa84b4454b36def05091326548240c4987cb9e93e1ae045ed0d5c7e6.png" alt="In-app marketing placements" width="60%" />
</Frame>
...
2. **Set Up The Extole and SessionM integration within your Extole account**
   ...
   * Navigate to the Partners page within the Extole platform. Select SessionM and install the integration.
     ...
     ![Screenshot showing Navigate to the Partners page within the Extole platform. Select SessionM and install the integration.](/images/extole/8d69451ad32c2836825c9bcb7325f6adb1f93917524b59a395b55537e7f57fa0.png)
   ...
   * Upon successful installation, a SessionM Reward Supplier is created and can be added to any Extole campaign. Through the SessionM Reward Supplier, Extole will fire a real-time webhook to the SessionM Events API everytime a user earns a reward through the referral program (example request below.) From there, the SessionM campaign will trigger the points or the offer to the user.
     ...
     ![Screenshot showing Upon successful installation, a SessionM Reward Supplier is created and can be added to any Extole campaign. Through the SessionM Reward Supplier, Extole...](/images/extole/a10e89bd1f65f7d9eb25db84435515ee994856d2c4e016d40dbcdee8ddb16c66.png)
