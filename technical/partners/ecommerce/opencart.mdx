...
For how the extension should deliver events — the payload, the credential, the outbox, retries, and verification — see [Send Platform Events to Extole](/technical/integration-overview/sending-platform-events).
...
The event was accepted without matching the integration. Work through the checklist in [Send Platform Events to Extole](/technical/integration-overview/sending-platform-events), starting with the program label.

## Related Documentation

- [Send Platform Events to Extole](/technical/integration-overview/sending-platform-events)
- [Integration Categories](/technical/integration-overview/integration-categories)
- [OpenCart Events](https://docs.opencart.com/developer-guide/events)

Building the OpenCart integration inside Extole, rather than installing and configuring it, is covered by [Create an Integration with the Management API](/technical/integration-overview/management-api-integration) and [Map Inbound Partner Events](/technical/integration-overview/integration-inbound-events).
