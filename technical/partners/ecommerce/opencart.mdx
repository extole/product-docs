...
For how the extension should deliver events — the payload, the credential, retries, and verification — see [Send Platform Events to Extole](/technical/building-custom-integrations/integration-types/sending-platform-events).
