...
For the platform build sequence — installing the library source, reshaping it, attaching webhooks, and verifying the result — see [Integration Categories](/technical/integration-overview/integration-categories), [Build an Outbound Library Integration](/technical/integration-overview/integration-build-outbound), and [Create the Integration Campaign and Component Model](/technical/integration-overview/integration-component-model).
...
| Braze API URL      | Your Braze API URL is specific to your Braze Instance. You can find it &lt;Anchor label="in Braze's API documentation" target="_blank" href="https://www.braze.com/docs/api/basics/#endpoints">in Braze's API documentation](https://www.braze.com/).   |
