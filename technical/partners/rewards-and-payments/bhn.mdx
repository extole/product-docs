...
For how this category is built in general terms, see [Integration Categories](/technical/integration-overview/integration-categories), [Build a Reward Fulfillment Integration](/technical/integration-overview/integration-build-reward-fulfillment) for the sequence, and [Create the Integration Campaign and Component Model](/technical/integration-overview/integration-component-model) for the campaign, component, and display metadata every path needs.
