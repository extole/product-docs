...
<img src="/images/extole/a9b22cd42c7003682edf1a40bc547f13443b548dc51169c713c1a2dc85b3c1f4.png" alt="Screenshot for How can I understand the status of a reward in the Extole platform? in the BHN (Blackhawk Network) guide." />
...
1. Look up the order number for the reward in the Extole platform. The Order number is the `Partner ID` located on the Reward event.
   ...
   <img src="/images/extole/8ecf6e5e63a0c5672d288597847d395026ccf111548fc52939799214ae0465f8.png" alt="Screenshot showing Look up the order number for the reward in the Extole platform." />
...
<img src="/images/extole/d1575b1143786c733292dc63eeaffe562145d60119579a7c99f4532d4dd16b4a.png" alt="Screenshot for How do I cancel a reward? in the BHN (Blackhawk Network) guide." />
