...
<img src="/images/extole/327553296d6a1128478e6d66120d0053286548b43849d5a5f8331e3b0d81629b.png" alt="Screenshot showing Once the integration is complete, you will be able to see rewards flow in real-time in your My Extole account." />
...
<img src="/images/extole/a9b22cd42c7003682edf1a40bc547f13443b548dc51169c713c1a2dc85b3c1f4.png" alt="Screenshot showing Extole leverages HTTP status codes from BHN API responses to update the status of a card order (aka reward) in the Extole platform. You can use the Extole..." />
...
1. Look up the order number for the reward in the Extole platform. The Order number is the `Partner ID` located on the Reward event.
   ...
   ![Screenshot showing Look up the order number for the reward in the Extole platform. The Order number is the Partner ID located on the Reward event.](/images/extole/8ecf6e5e63a0c5672d288597847d395026ccf111548fc52939799214ae0465f8.png)
...
![Screenshot showing Once you've reversed the reward, navigate back to the Reward in the Extole system and selectMark as Revokedif the reward had already been fulfilled, or...](/images/extole/d1575b1143786c733292dc63eeaffe562145d60119579a7c99f4532d4dd16b4a.png)
