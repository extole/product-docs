---
title: "Membership"
description: "Set up a membership referral program with branded links, website tags, signup and purchase tracking, rewards, mobile integration, and optional enhancements."
---

## Overview

[//]: # "What steps are required for setting up a membership referral program with Extole?"

Use this guide to set up a membership referral program that tracks signups and purchases, then rewards advocates and friends.

<Note>
  This guide covers a **referral** program for a membership business. If you are building a
  points-based loyalty program — members earning points for actions, accumulating a balance, and
  redeeming it — see
  [Build a Loyalty Program](/technical/platform-integrations/extensions/reward-bank/loyalty-program-guide).
</Note>
...
<Frame caption="Membership Referral Steps">
...
<Frame caption="Marketer Control Editing">
