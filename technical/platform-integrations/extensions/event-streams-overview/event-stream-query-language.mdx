...
campaign_context.quality=HIGH
campaign_context.quality=NONE
```
...
| `campaign_context.quality=HIGH`                               | STEP events a campaign selected at high quality   |
| `campaign_context.quality=NONE`                               | STEP events that were recorded but not attributed |
