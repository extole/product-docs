...
| Reserved and blocked words | The code cannot contain a reserved or blocked word *anywhere inside it*, not only as a whole word. `cass.dani12` is rejected because it contains `ass` |
