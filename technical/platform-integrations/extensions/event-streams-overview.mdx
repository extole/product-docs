...
To diagnose how a partner event maps to an Extole business event, see [Map Partner Events to Business Events](/technical/building-partner-integrations/integration-types/partner-events-map-to-business-events#how-to-test).
