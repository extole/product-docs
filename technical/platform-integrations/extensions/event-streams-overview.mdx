...
Use [Map Inbound Partner Events](/technical/building-custom-integrations/integration-types/integration-inbound-events#how-to-test) to send a sanitized event while the integration's **Event Stream** tab is running without filters.
