...
<Frame caption="Which operations are available depends on the reward's current state.">
  <img
    src="/images/extole/reward-state-lifecycle.svg"
    alt="A reward moves from earned to fulfilled to redeemed. The expire, revoke and cancel operations move it instead into one of four terminal states: cancelled, failed, revoked or expired."
  />
</Frame>
