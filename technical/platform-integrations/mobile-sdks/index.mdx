...
If you are unfamiliar with any of the terms or concepts mentioned in the integration guides, we recommend reading through our [Key Concepts](/technical/integration-overview/key-concepts). It may also be useful for you to review the overall structure of your program in our [Product Docs](https://docs.extole.com/docs/refer-a-friend).
