...
- An integration campaign with its model component and a `views` socket, built through [Create the Integration Campaign and Component Model](/technical/building-custom-integrations/integration-component-model).
