...
The view builds an editable payload from the integration's business events, enabled input rules, and program label. Add one test-event view per integration. [Map Inbound Partner Events](/technical/building-custom-integrations/integration-types/integration-inbound-events#how-to-test) covers its generated fields, including referral data and analytics isolation.
