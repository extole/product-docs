...
| Extole activity to reach a marketing automation, messaging, analytics, or customer data platform | Outbound | [Build an Outbound Integration](/technical/building-custom-integrations/integration-types/integration-build-outbound) |
...
| [Build an Outbound Integration](/technical/building-custom-integrations/integration-types/integration-build-outbound) | Installing and reshaping a complete maintained source, or adding controller-backed delivery when the source contains only metadata | Outbound |
