...
[Integration Categories](/technical/building-custom-integrations/integration-types/integration-categories) describes what each category contains. A partner that both sends outcomes and receives rewards uses two paths: build the inbound half first, then add the outbound resources.
