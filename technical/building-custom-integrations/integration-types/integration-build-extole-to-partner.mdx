---
title: "Build an Extole to Partner Library Integration"
description: "Install a maintained partner source, reshape it to the shape the partner page defines, and attach its webhooks and credential."
---
...
An Extole to Partner integration forwards Extole program activity out to a partner platform. Extole maintains a library source for most partners in this direction, so the build is an install and a reshape rather than a construction.
...
Do not add Partner to Extole business-event scaffolding to this install. A partner that orders gift cards, prepaid cards, points, or payouts uses the distinct [reward fulfillment model](/technical/building-custom-integrations/integration-types/integration-build-reward-fulfillment).
