...
[Create an Integration with the Management API](/technical/building-custom-integrations/management-api-integration) — then publish or request
...
`Example Reward Supplier Templates`
