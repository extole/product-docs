...
> Looking for Claude Desktop? If you prefer the desktop app, see the [Claude Desktop guide](/technical/extole-ai-tools/extole-mcp-server/setup-claude) instead.
