...
<div className="extole-devhub extole-home">
      ...
      <div className="extole-stack-pattern">
        ...
        <div className="extole-stack-pattern-groups">
          <div className="extole-stack-group">
            ...
            <ul>
              <li><a href="/api-reference/events/submit-an-event">Events API (runtime ingest)</a></li>
          ...
          <div className="extole-stack-group">
            ...
            <ul>
              ...
              <li><a href="/technical/partners/marketing-automation/braze">Braze</a></li>
              <li><a href="/technical/partners/marketing-automation/klaviyo">Klaviyo</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="extole-stack-pattern">
        ...
        <div className="extole-stack-pattern-groups">
          <div className="extole-stack-group">
            ...
            <ul>
              <li><a href="/api-reference/erasure/create-an-erasure-request">Request data erasure (API)</a></li>
          ...
          <div className="extole-stack-group">
            ...
            <ul>
              ...
              <li><a href="/api-reference/optout/get-opt-out-status">Check opt-out status (API)</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="extole-stack-pattern">
        ...
        <div className="extole-stack-pattern-groups">
          <div className="extole-stack-group">
            ...
            <ul>
              <li><a href="/api-reference/persons/create-a-person-shareable">Create sharelinks for your CRM</a></li>
              <li><a href="/api-reference/persons/list-person-rewards">Get person rewards</a></li>
            </ul>
          </div>
          <div className="extole-stack-group">
  ...
  <section className="extole-section">
    ...
    <div className="extole-support-grid">
      ...
      <a className="extole-pattern-card" href="mailto:support@extole.com">
