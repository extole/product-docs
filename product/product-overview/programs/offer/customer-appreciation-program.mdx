...
- [How to Set Up a Reward for Action Offer Program](/guides/programs-and-campaigns/how-to-set-up-a-reward-for-action-offer-program) — set up a standard, action-based Offer program instead of a direct thank-you send.
