...
> Once your test is up and running, you will see two (or more) live campaigns running against each other on your programs page. To compare performance, navigate to your **[Program Dashboard](/guides/platform-overview/exploring-my-extole/program-and-campaign-dashboards)** to view your test campaigns side-by-side.
