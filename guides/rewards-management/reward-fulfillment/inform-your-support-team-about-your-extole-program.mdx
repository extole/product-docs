...
For an overview of the reward lifecycle, see [WISMR 101: Understanding Missing Reward Requests](/guides/rewards-management/reward-fulfillment/wismr-101-understanding-customer-reward-inquiries) and [Investigating Missing Rewards and Attribution](/guides/rewards-management/reward-fulfillment/how-to-investigate-a-wismr-request)​.
...
Use **[Investigating Missing Rewards and Attribution](/investigating-missing-rewards-and-attribution)** as the standard investigation guide.
...
| Resource                                                                                                        | Purpose                                                                   |
| --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| **[WISMR 101: Understanding Customer Reward Inquiries](/guides/rewards-management/reward-fulfillment/wismr-101-understanding-customer-reward-inquiries)** | Learn how rewards are earned and why they may be missing.                 |
| **[Investigating Missing Rewards and Attribution](/investigating-missing-rewards-and-attribution)**          | Follow the standard investigation workflow for customer reward inquiries. |
