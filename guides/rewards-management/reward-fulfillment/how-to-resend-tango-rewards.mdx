...
You cannot cancel a Tango reward in Extole. Contact Extole Support, who will reach out to Tango to check cancellation eligibility. Tango sends an email confirmation once a reward is cancelled, and Extole can confirm the cancellation in the Tango history.
...
| Cancel and reissue (non-Amazon, unredeemed) | Contact Extole Support, who will check cancellation eligibility with Tango; prefer Tango resend when the only issue is email | Extole, through Tango |
