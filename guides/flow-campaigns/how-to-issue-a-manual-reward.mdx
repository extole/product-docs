...
description: "Create manual rewards on behalf of your customers in Extole's User Support for flow campaigns."
---
...
- **Did a rule failure cause the reward to be denied?**
  ...
  - If so, consider [approving the failed reward](/guides/flow-campaigns/how-to-approve-failed-rewards) instead of issuing a new one.

>

<Warning>
**Issuing a manual reward without proper review can lead to:**
</Warning>
