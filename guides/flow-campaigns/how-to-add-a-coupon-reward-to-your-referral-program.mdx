...
description: "Add coupon rewards and configure reward emails on your referral program"
---
...
If your campaign already has a coupon reward and you only want to replace it with another of the same type, see [Change the Reward on your Program](/guides/flow-campaigns/change-the-reward-on-your-program).
...
If the event you want already has a reward configured, don’t add a second one — instead follow [Change the Reward on your Program](/guides/flow-campaigns/change-the-reward-on-your-program) to swap the existing reward for your coupon.
