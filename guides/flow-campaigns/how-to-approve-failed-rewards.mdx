...
description: "Investigate and approve failed rewards on behalf of your customers in Extole's User Support for flow campaigns."
---
...
1. Navigate to **User Support** > **Person Search**, or to **Event Live View**, in My Extole.
...
- If required data (e.g., name, order ID) is missing and can't be added, **you may need to [issue a manual reward](/guides/flow-campaigns/how-to-issue-a-manual-reward)** instead.
