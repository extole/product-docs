...
Use this document alongside [Custom Data Queries using Extole Reports](/guides/dashboards-and-reporting/custom-data-queries-using-extole-reports), which covers expression syntax and functions.
