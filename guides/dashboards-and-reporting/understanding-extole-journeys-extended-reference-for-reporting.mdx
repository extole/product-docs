...
For one row per person with optional aggregated event counts, use the [Person report](/guides/dashboards-and-reporting/report-types/recommended-reports/person-report). For new-to-file people who reached a specific event, use [Visited Events](/guides/dashboards-and-reporting/report-types/recommended-reports/visited-events-report). For unique people who completed one action, use [People Who Took a Specific Action](/guides/dashboards-and-reporting/report-types/recommended-reports/people-who-took-a-specific-action-report). For configurable funnel counts, rates, and benchmarks, use [Funnel Performance](/guides/dashboards-and-reporting/report-types/recommended-reports/referral-funnel-performance-report). A short routing table for those four reports is in [Choosing the Right Report](/guides/dashboards-and-reporting/configuring-reports/choosing-the-right-report).
