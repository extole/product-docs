...
- For conventions related to CSV files that Extole generates, see: [https://docs.extole.com/docs/csv-encoding](/guides/dashboards-and-reporting/configuring-reports/csv-encoding)
