...
Some fields recur across entities and have a guide of their own. For `quality` and `visitType`, see [Visit Type and Quality](/guides/dashboards-and-reporting/extole-dashboards-and-metrics/visit-type-and-quality); for `journeyName` and the journey structure behind it, see [Understanding Extole Journeys](/guides/dashboards-and-reporting/understanding-extole-journeys-extended-reference-for-reporting).
