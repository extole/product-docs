...
- **Icon + Button**: A button that includes a custom icon for added emphasis.
 ...
 ![Screenshot showing Icon + Button: A button that includes a custom icon for added emphasis.](/images/extole/63035b6ecb33308dc3687d28681b6c8afac11dfe425bc5c4f4f02d77610974fe.png)
...
> Overlays are easy to add and test! Check out **[How to Add an Onsite CT](/guides/flow-campaigns/how-to-add-a-promotion-email-or-onsite-cta)** A and **[A/B Testing Your Campaign](/guides/strategy-and-best-practices/campaign-optimization/a-b-testing-your-campaign)** to get started.
