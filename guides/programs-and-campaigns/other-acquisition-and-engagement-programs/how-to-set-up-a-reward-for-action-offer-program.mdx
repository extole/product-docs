...
**Reward for Action** and **Offer** are two names for the same program type and template — you may see either name in My Extole and across our documentation. For a conceptual overview of the program, see [Offer](/product/product-overview/programs/offer/index).
...
![Screenshot showing Find the program label by clicking the view button on the Programs Page.](/images/extole/5aed410227a314d907a0508e91149e9a8897952e88db5a3ad7eaf0d8a09ce372.png)

![Screenshot showing Find the program label by clicking the view button on the Programs Page.](/images/extole/2fa286901884e9167dcd68ec66535f7ef9fffff2778ecf4b44f829a6fadaf242.png)
...
![Screenshot showing For the Journey Parameter , you want to use the name of the Business Event data with underscores instead of spaces and then choose Equals and enter the value.](/images/extole/4ef998acb606a970ea0e86ca7075cfad841f44a744c606b0755cbc44763770cc.png)
...
To add a second reward that fires only when event data matches (for example, a product id),
add the reward from **Outcome** using [How to Add a New Reward](/guides/flow-campaigns/how-to-add-a-new-reward),
then follow [How to Create a Reward That Triggers on Event Data](/guides/flow-campaigns/how-to-create-a-reward-that-triggers-on-event-data).
Confirm the new reward is attached to **Outcome** before you add the data comparison.

  1. On the flow page, find the event you want to send a reward on and click the + button

  2. Choose Add Reward and Participant  
​

![Screenshot showing ​](/images/extole/22f26c7f3957c4e795b7932958068cf50c2d1d1fc266b14c12829eda81a2380e.png)
