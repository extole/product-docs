...
On the[**Programs page**](https://my.extole.com/programs) or in the Campaign Dashboard, campaigns appear under their parent program and are edited in the **[Campaign Editor](/guides/programs-and-campaigns/campaign-creation-and-editing/using-extole-s-campaign-editor)** [.](/guides/programs-and-campaigns/campaign-creation-and-editing/using-extole-s-campaign-editor)
...
For instructions, see **[Making Updates to Your Campaign](/guides/programs-and-campaigns/managing-campaigns/making-updates-to-your-campaigns)**.
...
For instructions, see **[Creating a Program](/guides/platform-overview/creating-a-program)**. For more details on selected-audience campaigns, see **[Campaigns for Selected Audiences](/guides/programs-and-campaigns/other-acquisition-and-engagement-programs/campaigns-for-selected-audiences)**.
