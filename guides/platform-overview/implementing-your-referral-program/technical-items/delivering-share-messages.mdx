...
<Info>
**Share Messages and Program Emails Are Distinct**


This page covers share messages, which advocates send to their friends. Welcome, reward, and advocate stats emails come from your program rather than from an advocate, and they use a distinct sender address — see [What Address Do Program Emails Send From?](/technical/operational-tasks/account-configuration/extole-dns-requirements#what-address-do-program-emails-send-from).
</Info>
