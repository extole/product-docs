...
![Screenshot showing Rewards : Extole will notify your system when a reward has been earned](/images/extole/e64743525cc7d78cac7186b153de43185bd0359e581887e0e0aeabec5a1debce.jpg)
...
![Screenshot showing If you need changes to the payload or to the events, please talk to your Solutions Architect. You can also let your Solutions Architect know what data you'd...](/images/extole/1b4f1ea69381f39a447db9778474b04f5d44813079f30d70b6482b7fa8cbdbf4.png)
...
Extole sends only the fields that have a value for that person. A field that is empty for someone — the date of their last reward, when they have never earned one — is left out of their payload rather than sent as an empty value.

So the same webhook sends payloads with different sets of fields from one person to the next, and a field missing from a payload usually means that person has no value for it yet rather than that the webhook is set up wrongly. When you are checking a mapping, look at a payload for someone who does have the value.
