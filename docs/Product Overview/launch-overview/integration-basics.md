...
excerpt: >-
  Learn about what it means to integrate with Extole, what processes and system
  connections are required, and how long it takes to launch.
deprecated: false
hidden: false
metadata:
  title: ''
...
next:
  ...
  pages:
    ...
    - type: basic
      slug: receiving-data-from-extole
