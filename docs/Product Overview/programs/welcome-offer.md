...
title: Welcome Offer
excerpt: >-
  Grow your email list—and convert visitors—by offering users the ability to
  enter their email address to get a first-time visitor coupon to use on their
  first purchase.
deprecated: false
hidden: false
metadata:
