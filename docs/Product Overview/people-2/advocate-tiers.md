...
excerpt: >-
  Learn more about advocate tiers and the benefits of designing unique programs
  and rewards to target specific segments of your customers.
deprecated: false
hidden: false
metadata:
  title: ''
...
[//]: # "Does Extole have advocate tiers or tiered rewards?"

You may think of the advocates that participate in your programs as a single, unified group. However, Extole data gives you the power to create meaningful segments within the advocate group so that each segment can be treated differently. Each advocate segment should ultimately be targeted with unique rewarding and creative experiences tailored to them to make them feel special.

Our comprehensive reporting system can help you clearly define each of your advocate tiers. You can easily discover the number of advocates within a specific segment as well as the amount of revenue those advocates have driven for your brand. With this information, you and your CSM can work together to develop specific campaigns that address the needs and behaviors of these unique audiences.
