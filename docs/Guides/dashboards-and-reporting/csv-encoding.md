---
title: "CSV Encoding"
excerpt: "When downloading data in CSV format, there are some values that need to be quoted. Extole uses the following algorithm for determining which values to quote:\n"
---
