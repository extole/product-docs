...
excerpt: "List of commonly used reports to see overall performance of your program and get detailed activity on the participants from your programs.\n"
---
...
> How to run this report: [Metrics Report](doc:metrics-report)
...
> How to run this report: [Events Reports](doc:events-report)
...
> How to run this report: [Fulfilled Rewards Report](doc:fulfilled-rewards-report)
...
> How to run this report: [Top Promotion Sources](doc:top-promotion-sources-report)
...
> How to run this report: [Successful Advocates](doc:successful-advocates-report)

>

# **Best Practices**

- [Schedule your top reports:](doc:scheduled-reports) Automate delivery (weekly, monthly, year-end) for easy access and regular updates.
...
- [Leverage advanced filters/dimensions](doc:advanced-report-configuration): Fine-tune each report for your unique business questions and workflows.
