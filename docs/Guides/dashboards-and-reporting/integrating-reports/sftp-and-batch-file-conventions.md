...
excerpt: "Extole supports using automated batch files to improve the execution of common activities. Batch files (also known as offline files) are a common method for transferring large volumes of information, and most customer relationship managemen…\n"
---
...
[How do I access and use SFTP?](doc:using-extole-s-sftp-server)

## Additional Resources

To learn more about [how to send reports to an external SFTP server, please see this article.](doc:sending-reports-to-an-external-sftp)
