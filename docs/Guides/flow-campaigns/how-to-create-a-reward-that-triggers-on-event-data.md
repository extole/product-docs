...
_this_ reward to fire only when the data matches. For example, two rewards on the same conversion<br />step where the product decides which reward is issued.
