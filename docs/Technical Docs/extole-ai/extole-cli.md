...
title: Extole CLI
excerpt: >-
  A command-line tool for interacting with Extole from the terminal and
  integrating Extole into scripts and AI tools.
hidden: false
---
...
- Node.js 18 or later
- An Extole API token ([contact your CSM](https://www.extole.com/contact))
