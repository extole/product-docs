...
In order for Extole to track whether the referral resulted in a qualified account opening, you'll need to push <Anchor target="_blank" href="https://storage.googleapis.com/mantl-reports-documentation-production/schema/reports_documentation.html">MANTL's Simplified Acquisition report</Anchor> to <Anchor target="_blank" href="https://docs.extole.com/update/docs/extoles-sftp-server">Extole's SFTP Server</Anchor> on a daily basis. Extole will extract the `email`, `first_name,` `last_name`,  `utm_term_first_touch`,  `account_created_at`,  and `account_type` columns to attribute new accounts that used a referral code. Alternatively, you can push this data into your core or data warehouse and send Extole a <Anchor target="_blank" href="https://docs.extole.com/update/docs/file-based-events">daily events file</Anchor> of users who have opened accounts with your institution.
