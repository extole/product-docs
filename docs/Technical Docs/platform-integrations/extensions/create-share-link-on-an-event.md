...
excerpt: "Make sharing as easy as possible by precreating share links for every customer using the Extole extension or API"
---
...
```
POST https://api.extole.io/v5/persons/{person_id}/shareables
```
...
curl -X POST "https://api.extole.io/v3/persons/{person_id}/shareables" \
  ...
  -d '{"label": "refer-a-friend", "key":"refer-a-friend"}'
```
