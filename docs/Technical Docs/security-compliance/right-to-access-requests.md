...
excerpt: "Make General Data Protection Regulation (GDPR) and California Consumer Protection Act (CCPA) Right to Access requests.\n"
---
...
The [Search Person](ref:search-person) endpoint can be used to retrieve basic profile information and device information, including IP/Geo.
...
The [Get Person's Friends](ref:get-persons-friends)  endpoint gets the list of friend relationships for the advocate, including the reason the friend was connected to the advocate.
