...
excerpt: "Learn about three types of opt-out lists we maintain for Extole-powered programs, what your options are for managing lists, and answers to our most frequently asked questions.\n"
---
...
For details on how to use the Extole server, refer to our article on [Using Extole's SFTP Server](doc:sftp-and-batch-file-conventions).
...
```text
bavottukyw-947@yopmail.com
ogappaxok-513@yopmail.com
saink1952@teleworm.us
grathe6167@dayrep.com
nthismity1982@armyspy.com
```
