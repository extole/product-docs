...
excerpt: "If you are experiencing errors when logging into your Extole dashboard, below are some tips to help you resolve this issue.\n"
---
...
This can be corrected by disabling the offending plugin during the password reset process and trying again by [Requesting a Password Reset Email.](doc:login-troubleshooting-tips) Please consult your plugin's help page for instructions on how to disable your plugin.
