...
excerpt: "A good referral program drives quality new customer acquisition. A great program activates a significant and broad base of participants. Extole allows you to test messaging, CTAs, rewards, and rules to optimize all aspects of your program.\n"
---
...
If you're looking to specifically run an A/B test for your reward, please refer to our article on **[A/B Testing Your Offer](doc:a-b-testing-your-offer)**.
...
2. **[Duplicate](doc:making-updates-to-your-campaigns#h_4a0653a3a8)** your live campaign
...
4. Update your creatives on this campaign to align with the variable
  ...
  1. Check out **[Using Extole's Campaign Editor](doc:using-extole-s-campaign-editor)** for help
...
6. Click the Go Live button and choose the option to Go Live as a Test.
  ...
  - Note: This will automatically split your campaign traffic 50/50, which means existing advocates will continue to see the control campaign while new customers will be split. To learn more about Pausing vs. Ending, **[check out this article](doc:pausing-ending-and-scheduling-campaigns)**.
...
> Once your test is up and running, you will see two (or more) live campaigns running against each other on your programs page. To compare performance, navigate to your **[Program Dashboard](doc:program-and-campaign-dashboards)** to view your test campaigns side-by-side.
...
> This is possible using our **[Promote to Audience](doc:how-to-send-a-promotional-email-to-an-audience)** feature if you would like to initiate your test via email.
