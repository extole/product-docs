...
excerpt: "This article covers how to perform quality assurance (QA) tests on your program. Bear in mind that this is completely optional. As part of your Extole launch support, we will conduct a rigorous QA process that tests your program on multiple…\n"
---
...
Before starting the QA process, be sure to properly classify yourself as a tester so your events don't get counted in the analytics dashboard—see the article [How Do I Prevent Testing Data from Appearing in my Analytics Dashboard?](doc:how-do-i-prevent-testing-data-from-appearing-in-my-analytics-dashboard)
