...
excerpt: "All images should be in .jpg or .png format and their size must not exceed 3МВ. You can use any online image compressor to reduce file size.\n"
---
...
- [Welcome Offer Program Asset Guide](doc:welcome-offer-asset-guide)
- [Nominations Program Asset Guide](doc:nomination-asset-guide)
- [Sweepstakes Program Asset Guide](doc:sweepstakes-asset-guide)
- [Drop A Hint Program Asset Guide](doc:drop-a-hint-asset-guide)
- [Friends and Family Program Asset Guide](doc:friends-family-asset-guide)
