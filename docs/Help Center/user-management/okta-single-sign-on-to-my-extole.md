...
excerpt: "My Extole supports a wide range of services for SSO. In order to connect Okta to My Extole, you'll use an OpenID Connect (OIDC) identity provider using the following steps.\n"
---
