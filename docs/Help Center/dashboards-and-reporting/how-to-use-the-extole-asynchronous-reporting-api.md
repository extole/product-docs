...
excerpt: "Extole provides asynchronous API endpoints to download various reports. To run, check the status of, and download a report, you need to make calls across three API endpoints.\n"
---
...
- **<REPORT_NAME>**: Name of report you want to download. Available reports are listed here: [How to Run Data Reports](doc:how-to-run-a-report)
- **<FORMAT>**: JSON, CSV
