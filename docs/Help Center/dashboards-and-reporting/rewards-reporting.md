...
excerpt: "This article describes how you can easily pull data on your rewards configured for your programs. In particular, the following two reports are covered:\n"
---
...
- **Reward States:** The particular state(s) of rewards that you're interested in (e.g. earned, fulfilled, redeemed, etc.)
  ...
  - [Please see our Help Center article here for more on reward states](https://success.extole.com/hc/en-us/articles/360001560447-Supported-Rewards-and-Reward-States  <!-- TODO: legacy Zendesk URL — verify target slug -->)
